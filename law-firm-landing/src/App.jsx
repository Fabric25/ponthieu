...
const testimonials = [
  {
    quote:
      'Their team navigated a complicated acquisition with clarity and confidence. We always felt one step ahead.',
    name: 'Alex Martinez',
    role: 'COO, NorthBridge Holdings',
  },
  {
    quote:
      'From our first meeting we knew we were in the right hands. Their attention to detail saved our family business.',
    name: 'Priya Desai',
      ...
      <main>
        <section className="hero" id="top">
          <div className="hero-text">
            ...
            <h1>
              Guiding businesses and families through pivotal decisions with unwavering expertise.
            </h1>
            <p className="intro">
              At Ponthieu Legal Group, our attorneys pair deep industry knowledge with attentive partnership.
              From proactive counseling to high-stakes litigation, we deliver strategies that safeguard what
              matters most.
            </p>
        ...
        <section className="practice" id="practice-areas">
          <header className="section-heading">
            ...
            <p>
              Our attorneys collaborate across disciplines to offer proactive guidance and swift responses when
              stakes are highest.
            </p>
          </header>
        ...
        <section className="about" id="about">
          ...
          <div className="about-content">
            <p>
              Ponthieu Legal Group is a collective of former big-law partners and in-house counsel united by a
              belief in human-centered advocacy. We stay close to your business, anticipate risk, and craft legal
              strategies that accelerate momentum.
            </p>
            <ul>
        ...
        <section className="cta">
          <div className="cta-content">
            ...
            <p>
              We partner with leaders who demand clarity, precision, and responsive counsel. Let’s discuss how our
              team can advance your objectives.
            </p>
